...
export default function PrivacyPage() {
    return (
        <div className="max-w-4xl mx-auto py-16">
            ...
            <Paragraph>
                This privacy policy ('Privacy Policy') governs how we, Live Momentum Ltd. and/or any other member of the StreamElements group (together, "StreamElements", "we", "our" or "us") use, collect and store Personal Data we collect or receive from or about you ("User", "you") such as in the following use cases:
            </Paragraph>
            <br />
            <ul>
                <li><span className="font-bold">1.</span> When you browse or visit our website, https://pickle.pw/ ('Website');</li>
                <li><span className="font-bold">2.</span> When you make use of, or interact with, our Website</li>
                <ul>
                    <li><span className="font-bold">2.1.</span> When you create an account and/or log in clicking on "Connect with Twitch"</li>
                    <li><span className="font-bold">2.2.</span> When you create an account and/or log in clicking on "Connect with YouTube"</li>
                    <li><span className="font-bold">2.3.</span> When you create an account and/or log in clicking on "Connect with Facebook"</li>
                    <li><span className="font-bold">2.4.</span> When you create an account and/or log in clicking on "Connect with Trovo"</li>
                    <li><span className="font-bold">2.5.</span> When you click on the 'Join us' tab and/or you join to 'Discord' and you make use of 'StreamElements Chat Stats'</li>
                    <li><span className="font-bold">2.6.</span> When you download our software, and/or plugin and/or desktop app</li>
                    <li><span className="font-bold">2.7.</span> When you apply to join StreamElements DreamTeam</li>
                    <li><span className="font-bold">2.8.</span> When you sign up to and/or comment on our blog on 'Medium'</li>
                    <li><span className="font-bold">2.9.</span> When you contact us (e.g. customer support, when you submit a request, chat with us or leave us a message)</li>
                </ul>
                <li><span className="font-bold">3.</span> When you make use of, or interact with our Dashboard</li>
                <li><span className="font-bold">4.</span> When you attend a marketing event and provide Personal Data</li>
                <li><span className="font-bold">5.</span> When you exchange business cards with us</li>
                <li><span className="font-bold">6.</span> When we use the Personal Data of our suppliers</li>
                <li><span className="font-bold">7.</span> When we use the Personal Data of our customers</li>
                <li><span className="font-bold">8.</span> When you interact with us on our social media profiles (e.g., Facebook, Instagram, X, LinkedIn, etc) and we use the publicly available information.</li>
            </ul>
            ...
            <ul>
                <li><span className="font-bold">1.</span> What information we collect, why we collect it, and how it is used</li>
                <li><span className="font-bold">2.</span> How we protect and store your Personal Data</li>
                <li><span className="font-bold">3.</span> How we share your Personal Data</li>
                <li><span className="font-bold">4.</span> Additional information regarding transfers of Personal Data</li>
                <li><span className="font-bold">5.</span> Your rights</li>
                <li><span className="font-bold">6.</span> Use by children</li>
                <li><span className="font-bold">7.</span> Public information about your activity on the services</li>
                <li><span className="font-bold">8.</span> How can I delete my account?</li>
                <li><span className="font-bold">9.</span> Links to and interaction with third party product</li>
                <li><span className="font-bold">10.</span> Log files</li>
                <li><span className="font-bold">11.</span> Cookies and other tracking technologies</li>
                <li><span className="font-bold">12.</span> Use of Analytics Tools</li>
                <li><span className="font-bold">13.</span> California privacy rights</li>
                <li><span className="font-bold">14.</span> Our California do not track notice</li>
                <li><span className="font-bold">15.</span> Deletion of content from California residents</li>
                <li><span className="font-bold">16.</span> How to contact us</li>
            </ul>
            ...
            <H3>What information we collect, why we collect it, and how it is used.</H3>
            <Table className="text-xs">
                <TableHeader>
                    <TableRow>
                        <TableCell className="font-bold">Data we collect</TableCell>
                        <TableCell className="font-bold">Why is the data collected and for what purposes?</TableCell>
                        <TableCell className="font-bold">Legal basis (GDPR only)</TableCell>
                        <TableCell className="font-bold">Third parties with whom we share your data</TableCell>
                        <TableCell className="font-bold">Period of storage</TableCell>
                        <TableCell className="font-bold">Consequences of not providing the data</TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell colSpan={6} className="font-bold">When you browse or visit our Website</TableCell>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    <TableRow>
            ...
            <Table className="text-xs">
                <TableBody>
                    <TableRow>
                        <TableCell>
                            <ul>
                                <li><span className="font-bold">1.</span> Username</li>
                                <li><span className="font-bold">2.</span> Email address</li>
                                <li><span className="font-bold">3.</span> IP address</li>
                                <li><span className="font-bold">4.</span> Stream data (channel information, subscribers information)</li>
                                <li><span className="font-bold">5.</span> Any other data you decide to provide/supply</li>
                            </ul>
                        </TableCell>
                        <TableCell>
                            <ul>
                                <li><span className="font-bold">1.</span> Signing up and creating an account</li>
                                <li><span className="font-bold">2.</span> Sending stream reports</li>
                                <li><span className="font-bold">3.</span> To use our system features, such as showing alerts, widgets, the bot and other features we offer the user</li>
                            </ul>
                        </TableCell>
                        <TableCell>
                            Processing is necessary for the performance of a contract to which the data subject is party or in order to take steps at the request of the data subject prior to entering into a contract. Legitimate interest (e.g. sign you up to our service)	3rd party platforms:
                        </TableCell>
                        <TableCell>
                            3rd party platforms:
                            <ul>
                                <li><span className="font-bold">1.</span> AWS (hosting services, USA)</li>
                                <li><span className="font-bold">2.</span> Heap (business intelligence services, USA)</li>
                            </ul>
                        </TableCell>
                        <TableCell>
            ...
            When you click on "Connect with YouTube"
            Username
            Email address
            IP address
            Stream data (channel information, subscribers information)
            Any other data you decide to provide/supply
            Signing up and creating an account
            Sending stream reports
            Processing is necessary for the performance of a contract to which the data subject is party or in order to take steps at the request of the data	3rd party platforms:
            AWS (hosting services, USA)
            Heap (business intelligence services, USA)
            ...
            Cannot receive stream reports
            When you click on the 'Join us' tab and/or you join to 'Discord' and you make use of 'StreamElements Chat Stats'
            Username
            Email address
            IP address
            Stream data (channel information, subscribers information)
            Any other data you decide to provide/supply
            Chat in the StreamElements group on Discord
            Receive information about us
            Processing is necessary for the performance of a contract to which the data subject is party or in order to take steps at the request of the data subject prior to entering into a contract Legitimate interest (e.g. respond to a query sent by you)	3rd party platforms:
            AWS (hosting services, USA)
            Heap (business intelligence services, USA)
            Discord (chat platform, USA)
            Until we no longer need the information and proactively delete it or you send a valid deletion request. Please note that we may retain it for a longer or shorter period in accordance with data retention laws.Please note that we may retain it for a longer or shorter period in accordance with data retention laws.
            Cannot chat in the StreamElements group on Discord
            Cannot receive information about us
            When you download our software, plug-ins (and app(s))
            Username
            Stream data (IP address, channel information, subscribers information and other metadata)
            Download our software, plug-ins and apps
            Sending stream reports
            Processing is necessary for the performance of a contract to which the data subject is party or in order to take steps at the request of the data subject prior to entering into a contract Legitimate interest (e.g. respond to a query sent by you)	3rd party platforms:
            AWS (hosting services, USA)
            Heap (business intelligence services, USA)
            Until we no longer need the information and proactively delete it or you send a valid deletion request. Please note that we may retain it for a longer or shorter period in accordance with data retention laws.Please note that we may retain it for a longer or shorter period in accordance with data retention laws.
            Cannot download our software, plug-ins and apps
            Cannot receive stream reports
            ...
            Sending marketing communications
            Processing is necessary for the performance of a contract to which the data subject is party or in order to take steps at the request of the data subject prior to entering into a contract Legitimate interest (e.g. add you to our StreamElements DreamTeam)	3rd party platforms:
            AWS (hosting services, USA)
            Heap (business intelligence services, USA)
            Until we no longer need the information and proactively delete it or you send a valid deletion request. Please note that we may retain it for a longer or shorter period in accordance with data retention laws.Please note that we may retain it for a longer or shorter period in accordance with data retention laws
            Cannot join the StreamElements DreamTeam
            Cannot send yoy marketing communications
            When you sign up to or comment on our blog on 'Medium'
            Username
            Email address
            IP address
            To post your comments/response in our blog	The data subject has given consent to the processing of his or her personal data for one or more specific purposes Legitimate interest (e.g. to post your comment on our blog)	3rd party platforms:
            AWS (hosting services, USA)
            Heap (business intelligence services, USA)
            Until we no longer need the information and proactively delete it or you send a valid deletion request. Please note that we may retain it for a longer or shorter period in accordance with data retention laws.	Cannot post your comments/response in our blog
            When you contact us (e.g. customer support, when you submit a request, chat with us or leave us a message)
            Username
            Provider
            Channel Id
            Country
            ...
            The data subject has given consent to the processing of his or her personal data for one or more specific purposes Legitimate interest (e.g. to post your comment on our blog)	3rd party platforms:
            AWS (hosting services, USA)
            Heap (business intelligence services, USA)
            Zendesk (chat services)
            Until we no longer need the information and proactively delete it or you send a valid deletion request. Please note that we may retain it for a longer or shorter period in accordance with data retention laws.	Cannot assist you and respond your query
            When you sign up/login to, make use of, or interact with our Dashboard
            Username
            Email address
            IP address
            Stream data (channel information, subscribers information)
            Any other data you decide to provide/supply
            Use our dashboard	Processing is necessary for the performance of a contract to which the data subject is party or in order to take steps at the request of the data subject prior to entering into a contract Legitimate interest (e.g. respond to a query sent by you)	3rd party platforms:
            AWS (hosting services, USA)
            Heap (business intelligence services, USA)
            Until we no longer need the information and proactively delete it or you send a valid deletion request. Please note that we may retain it for a longer or shorter period in accordance with data retention laws.	Cannot use our dashboard
            ...
            Processing is necessary for the performance of a contract to which our customer is a party. Compliance with a legal obligation (e.g. tax laws, bookkeeping laws, etc.). Legitimate interest (e.g. send you contract-related communications)	3rd party platforms:
            AWS (hosting services, USA)
            Heap (business intelligence services, USA)
            Until we no longer need the information and proactively delete it or you send a valid deletion request. Please note that we may retain it for a longer or shorter period in accordance with data retention laws.
            ...
            When you interact with us on our social media profiles (e.g. Facebook, Twitter, LinkedIn, etc) and we use the publically available information
            Full name
            Email address
            Company name
            Establishing a business connection
            Send you information about us
            The data subject has given consent to the processing of his or her personal data for one or more specific purposes Legitimate interest (e.g. send you more information about us)	3rd party platforms:
            AWS (hosting services, USA)
            Heap (business intelligence services, USA)
            Until we no longer need the information and proactively delete it or you send a valid deletion request. Please note that we may retain it for a longer or shorter period in accordance with data retention laws.
            Cannot establish a business connection
            Cannot send you information about us
            ...
            External transfers: Where we transfer your Personal Data outside of EU/EEA, for example to third parties who help provide our products and services, we will obtain contractual commitments from them to protect your Personal Data;
            ...
            You have a right to access information held about you. Your right of access would normally be exercised free of charge, however, we reserve the right to charge an appropriate administrative fee where permitted by applicable law;
            ...
            You can exercise your rights by contacting us atprivacy@streamelements.com. Subject to legal and other permissible considerations, we will make every reasonable effort to honor your request promptly or inform you if we require further information in order to fulfil your request. When processing your request, we may ask you for additional information to confirm your identity and for security purposes, before disclosing the Personal Data requested to you. We reserve the right to charge a fee where permitted by law, for instance if your request is manifestly unfounded or excessive.
            ...
            Analytic tools
            Google Analytics The Website may use a tool called "Google Analytics" to collect information about use of the Website. Google Analytics collects information such as how often users visit this Website, what pages they visit when they do so, and what other sites they used prior to coming to this Website. We use the information we get from Google Analytics to maintain and improve the Website and our products. We do not combine the information collected through the use of Google Analytics with personally identifiable information. Google's ability to use and share information collected by Google Analytics about your visits to this Website is restricted by the Google Analytics Terms of Service, available athttp://www.google.com/analytics/terms/us.html/, and the Google Privacy Policy, available at http://www.google.com/policies/privacy/collects and processes data specifically in connection with Google Analytics athttp://www.google.com/policies/privacy/partners/Analytics by downloading and installing the Google Analytics Opt-out Browser Add-on, available athttps://tools.google.com/dlpage/gaoptout/
            Firebase Analytics We also use a similar tool called "Google Analytics for Firebase". By enabling this tool, we enable the collection of data about App Users, including via identifiers for mobile devices (including Android Advertising ID and Advertising Identifier for iOS), cookies and similar technologies. We use the information we get from Google Analytics for Firebase to maintain and improve our App(s). We do not facilitate the merging of personally-identifiable information with non-personally identifiable information unless we have robust notice of, and your prior affirmative (i.e., opt-in) consent to, that merger. In addition, we bring to your attention that Google Analytics śfor Firebase's terms (available at https://firebase.google.com/terms/)
            Heap. The Website may use a tool called "Heap Analytics" which is a user behavioral analytics product and service. Heap collects and analyzes data about how users are interacting with our Website. Heap does this by collecting data on what users are doing, including but not limited to what webpages they visit, what users click on, where those users are located, what browser or platform those users are using. Heap is GDPR compliant, you can read further information onhttps://heapanalytics.com/blog/company/heaps-commitment-to-gdpr-and-data-privacy.
            California privacy rights
            California Civil Code Section 1798.83 permits our customers who are California residents to request certain information regarding our disclosure of Personal Information to third parties for their direct marketing purposes. To make such a request, please send an email to privacy@streamelements.com. Please note that we are only required to respond to one request per customer each year.
            ...
            Contact Us
            If you have any questions, concerns or complaints regarding our compliance with this notice and the data protection laws, or if you wish to exercise your rights, we encourage you to first contact us at privacy@streamelements.com.
        </div>
    )
}
