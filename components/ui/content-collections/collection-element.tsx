        ...
        <TooltipTrigger asChild>
          ...
          >
            <div className="flex flex-col gap-1">
              <ContentNotePoster
                posterUrl={item.content.coverUrl}
                size="sm"
                className="cursor-pointer shadow-sm transition-all duration-300 hover:scale-105 hover:shadow-2xl"
              />
              <div className="flex flex-col whitespace-normal text-start">
                <p className="line-clamp-2 max-w-[100px] whitespace-normal text-xs underline-offset-2 hover:underline">
                  {item.content.title}
                </p>
