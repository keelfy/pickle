...
export default function StreamElementsIcon({ className }: Props) {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="51 50 141 141" className={className}>
            <path d="M132.881 62.5619L136.431 69.4596C159.953 77.8886 176.114 100.584 176.114 125.714C176.114 158.671 149.292 185.477 116.314 185.477C83.3361 185.477 56.5269 158.671 56.5269 125.714C56.5269 100.571 72.6884 77.8886 96.2103 69.4596L99.7596 62.575C71.2739 70.0224 51 95.9508 51 125.714C51 161.708 80.3107 191 116.327 191C152.343 191 181.654 161.708 181.654 125.714C181.654 95.9508 161.38 70.0093 132.881 62.5619Z" fill="url(#paint0_linear_109_47)"></path>
            <mask id="mask0_109_47" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x="60" y="69" width="113" height="113">
                <path d="M116.327 181.354C147.162 181.354 172.159 156.373 172.159 125.557C172.159 94.7416 147.162 69.7606 116.327 69.7606C85.4919 69.7606 60.4951 94.7416 60.4951 125.557C60.4951 156.373 85.4919 181.354 116.327 181.354Z" fill="white"></path>
            </mask>
