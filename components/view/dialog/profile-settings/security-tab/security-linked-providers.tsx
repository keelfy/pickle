...
const getProviderIcon = (providerType: string): React.ComponentType<{ className?: string }> => {
...
export default function SecurityLinkedProviders({ flow, updateFlow, isFlowLoading }: Props) {
    const IdentityElement = ({ providerName, providerType }: { providerName: string, providerType: string }) => {
        return (
