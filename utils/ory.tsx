...
import { isUiNodeInputAttributes, UiNode, UiNodeInputAttributes } from "@ory/client-fetch";

export function mapOryUiNodesToShadcnForm(node: UiNode, key: number, isLoading: boolean = false, submitText?: string) {
